...
*/
func (a *MerchantAPIService) CreateMerchant(ctx context.Context) ApiCreateMerchantRequest {
	return ApiCreateMerchantRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return Merchant
func (a *MerchantAPIService) CreateMerchantExecute(r ApiCreateMerchantRequest) (*Merchant, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MerchantAPIService.CreateMerchant")
	if err != nil {
